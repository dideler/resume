...
\OrganizationEntry{Team Member}{2012-present}
{Software Niagara, \url{softwareniagara.com}}
{
 \begin{itemize} \itemsep -1pt
   \item Grassroots organization which aims to improve the Niagara Region tech scene 
   \item Organize social and informative events, such as DemoCamps and Software Coworking
   \item Built \url{voteinpublic.com} with the team as a weekend project and demoed it at DemoCamp
 \end{itemize}
}
\sepspace
