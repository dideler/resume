...
{Landlord Web Solutions, Ontario, Canada}
{
 \begin{itemize} \itemsep -1pt
   ...
   \item Created a CRUD application for managing important aspects of our annual Landlord WEBCON conference,
         such as ticket sales, invoices, promo codes, and sponsors. Metrics gave key insights for guiding
         decision making, especially around measuring and boosting ticket sales.
