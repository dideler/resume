...
\EducationEntry{BSc. Computer Science (Honours \& Co-op)}
{Sep 2007 - Jun 2013}
{Brock University, Ontario, Canada}
{
 \begin{itemize}  \itemsep -1pt % Reduce space between items.
   ...
   \item Tutor for introductory COSC, MATH, and APCO courses, 2011-2013
   ...
   \item Co-founded Chess Club and BrockBots, a computer science
...
\EducationEntry{Data Specialist (Co-op)}{Jan 2009 - Apr 2009}
...
{
 \begin{itemize} \itemsep -1pt
   \item Created the Brock CSC organization on GitHub which has 6 repositories and 10 members:
