...
{Funding Circle, London, UK}
{
 \begin{itemize} \itemsep -1pt
   ...
   \item Built tooling to make the engineering team more effective, such as dockerising current stack
   \item Built various tools to strengthen business operations and comply with financial conduct regulations.
         Such as the open source Shipment Tracker, % https://engineering.fundingcircle.com/blog/2016/09/06/shipping-in-fintech/
         to capture audit trails and improve visibility of releasing software. And a data warehouse built on
         AWS services for daily reconciliation tasks.
 ...
 \end{itemize}
 \textbf{Tools:} Ruby, Rails, PostgreSQL, GitHub, Capistrano, Jenkins, Docker, JIRA, AWS
}
\sepspace
