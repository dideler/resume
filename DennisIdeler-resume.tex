...
%% \moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}\smallskip
% \moveleft.5\hoffset\centerline{23 Woodcrest Dr, St.\hspace{2 pt}Catharines, ON L2T 2Y2 $\bullet$
...
% Option D: Name with horizontal line, and CONTACT INFO section below.
 \moveleft.5\hoffset\centerline{\large\bf \Huge Dennis Ideler} % Center name over entire width of resume
 \moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}\smallskip % Draw line the width of resume
...
\begin{tabular}{l l}
  ...
  {\sl Website:} & www.dennisideler.com \\ % TODO: add linkedin and github?
...
% BAR: Background, Action, Result
    ...
    {\sl Contributor \& Mentor for Freeseer project} \hfill % freeseer.github.com
    ...
    {\sl Systems Analyst (Co-op Student)} \hfill St.\hspace{2 pt}Catharines, Ontario % & Information Architect
	\begin{itemize}  \itemsep -2pt % Reduce space between items.
