...
{Funding Circle, London, UK}
{
 \begin{itemize} \itemsep -1pt
   \item Utilising extreme programming techniques to continuously deliver reliable software
   \item Built tooling to make the engineering team more effective
   \item Focus on strengthening business operations to comply with financial conduct regulations.
         Built an open source regulatory compliance tool, Shipment Tracker,
         to capture an audit trail and improve communication within tech team.
